...
import com.zaki.zakidada.mapper.AppMapper;
...
import com.zaki.zakidada.model.enums.AppScoringStrategyEnum;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (StringUtils.isNotBlank(appName)) {
            ...
            ThrowUtils.throwIf(appName.length() < 2, ErrorCode.PARAMS_ERROR, "应用名称不能少于2个字符");
        }
